                    ...
                    <form class="space-y-4 md:space-y-6" action="#">
                        ...
                        <div className="flex flex-col lg:flex-row w-full gap-2">
                            <div className="w-full">
                                ...
                                <input type="text" name="email" id="email" className="input-style" placeholder="Full Name" required=""/>
                            </div>
                            <div className="w-full">
                        ...
                        <div className="flex flex-col lg:flex-row w-full gap-2">
                            ...
                            <div className="w-full">
                                ...
                                <input type="confirm-password" name="confirm-password" id="confirm-password" placeholder="••••••••" className="input-style" required=""/>
                            </div>
                        </div>
